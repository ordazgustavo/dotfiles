...
complete -c swift -n '_swift_swift_using_command "swift run"' -l static-swift-stdlib -d 'Link Swift stdlib statically'
complete -c swift -n '_swift_swift_using_command "swift run"' -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '_swift_swift_using_command "swift test" "list last help"' -l static-swift-stdlib -d 'Link Swift stdlib statically'
complete -c swift -n '_swift_swift_using_command "swift test" "list last help"' -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '_swift_swift_using_command "swift package describe"' -l type -d 'json | text'
...
complete -c swift -n '_swift_swift_using_command "swift package experimental-install"' -l static-swift-stdlib -d 'Link Swift stdlib statically'
complete -c swift -n '_swift_swift_using_command "swift package experimental-install"' -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '_swift_swift_using_command "swift package experimental-uninstall"' -l static-swift-stdlib -d 'Link Swift stdlib statically'
complete -c swift -n '_swift_swift_using_command "swift package experimental-uninstall"' -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
...
complete -c swift -n '_swift_swift_using_command "swift package unedit"' -l force -d 'Unedit the package even if it has uncommited and unpushed changes'
...
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l package-path -d 'Specify the package path to operate on (default current directory). This changes the working directory before any other operation' -r -f -a '(__fish_complete_directories)'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l cache-path -d 'Specify the shared cache directory path' -r -f -a '(__fish_complete_directories)'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l config-path -d 'Specify the shared configuration directory path' -r -f -a '(__fish_complete_directories)'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l security-path -d 'Specify the shared security directory path' -r -f -a '(__fish_complete_directories)'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l scratch-path -d 'Specify a custom scratch directory path (default .build)' -r -f -a '(__fish_complete_directories)'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l pkg-config-path -d 'Specify alternative path to search for pkg-config `.pc` files. Use the option multiple times to
specify more than one path.' -r -f -a '(__fish_complete_directories)'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l enable-dependency-cache -d 'Use a shared cache when fetching dependencies'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l disable-dependency-cache -d 'Use a shared cache when fetching dependencies'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l enable-build-manifest-caching
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l disable-build-manifest-caching
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l manifest-cache -d 'Caching mode of Package.swift manifests (shared: shared cache, local: package\'s build directory, none: disabled'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l verbose -s v -d 'Increase verbosity to include informational output'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l very-verbose -l vv -d 'Increase verbosity to include debug output'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l quiet -s q -d 'Decrease verbosity to only include error output.'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l disable-sandbox -d 'Disable using the sandbox when executing subprocesses'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l netrc -d 'Use netrc file even in cases where other credential stores are preferred'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l enable-netrc -d 'Load credentials from a netrc file'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l disable-netrc -d 'Load credentials from a netrc file'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l netrc-file -d 'Specify the netrc file path' -r -f -a '(for i in *.{}; echo $i;end)'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l enable-keychain -d 'Search credentials in macOS keychain'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l disable-keychain -d 'Search credentials in macOS keychain'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l resolver-fingerprint-checking
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l resolver-signing-entity-checking
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l enable-signature-validation -d 'Validate signature of a signed package release downloaded from registry'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l disable-signature-validation -d 'Validate signature of a signed package release downloaded from registry'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l enable-prefetching
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l disable-prefetching
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l force-resolved-versions -l disable-automatic-resolution -l only-use-versions-from-resolved-file -d 'Only use versions from the Package.resolved file and fail resolution if it is out-of-date'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l skip-update -d 'Skip updating dependencies from their remote during a resolution'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l disable-scm-to-registry-transformation -d 'disable source control to registry transformation'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l use-registry-identity-for-scm -d 'look up source control dependencies in the registry and use their registry identity when possible to help deduplicate across the two origins'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l replace-scm-with-registry -d 'look up source control dependencies in the registry and use the registry to retrieve them instead of source control when possible'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l default-registry-url -d 'Default registry URL to use, instead of the registries.json configuration file'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l configuration -s c -d 'Build with configuration' -r -f -k -a 'debug release'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -o Xcc -d 'Pass flag through to all C compiler invocations'
...
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l triple
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l sdk -r -f -a '(__fish_complete_directories)'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l toolchain -r -f -a '(__fish_complete_directories)'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l sanitize -d 'Turn on runtime checks for erroneous behavior, possible values: address, thread, undefined, scudo' -r -f -k -a 'address thread undefined scudo'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l auto-index-store -d 'Enable or disable indexing-while-building feature'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l enable-index-store -d 'Enable or disable indexing-while-building feature'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l disable-index-store -d 'Enable or disable indexing-while-building feature'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l enable-parseable-module-interfaces
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l jobs -s j -d 'The number of jobs to spawn in parallel during the build process'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l use-integrated-swift-driver
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l explicit-target-dependency-import-check
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l experimental-explicit-module-build
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l build-system -r -f -k -a 'native xcode'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -o debug-info-format
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l enable-dead-strip -d 'Disable/enable dead code stripping by the linker'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l disable-dead-strip -d 'Disable/enable dead code stripping by the linker'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l static-swift-stdlib -d 'Link Swift stdlib statically'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l no-static-swift-stdlib -d 'Link Swift stdlib statically'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l disable-local-rpath -d 'Disable adding $ORIGIN/@loader_path to the rpath by default'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -l version -d 'Show the version.'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -o help -s h -l help -d 'Show help information.'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'clean' -d 'Delete build artifacts'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'purge-cache' -d 'Purge the global repository cache.'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'reset' -d 'Reset the complete cache/build directory'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'update' -d 'Update package dependencies'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'describe' -d 'Describe the current package'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'init' -d 'Initialize a new package'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'experimental-install' -d 'Offers the ability to install executable products of the current package.'
...
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'diagnose-api-breaking-changes' -d 'Diagnose API-breaking changes to Swift modules in a package'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'dump-symbol-graph' -d 'Dump Symbol Graph'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'dump-package' -d 'Print parsed Package.swift as JSON'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'edit' -d 'Put a package in editable mode'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'unedit' -d 'Remove a package from editable mode'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'config' -d 'Manipulate configuration of the package'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'resolve' -d 'Resolve package dependencies'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'show-dependencies' -d 'Print the resolved dependency graph'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'tools-version' -d 'Manipulate tools version of the current package'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'compute-checksum' -d 'Compute the checksum for a binary artifact.'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'archive-source' -d 'Create a source archive for the package'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'completion-tool' -d 'Completion tool (for shell completions)'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'plugin' -d 'Invoke a command plugin or perform other actions on command plugins'
complete -c swift -n '_swift_swift_using_command "swift package" "clean purge-cache reset update describe init experimental-install experimental-uninstall diagnose-api-breaking-changes dump-symbol-graph dump-package edit unedit config resolve show-dependencies tools-version compute-checksum archive-source completion-tool plugin help"' -f -a 'help' -d 'Show subcommand help information.'
